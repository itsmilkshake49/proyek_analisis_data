...
season_avg = all_df.groupby("season")["PM2.5"].mean().reset_index()
...
sns.barplot(x='season', y='PM2.5', data=season_avg, hue='season', palette=palette_colors, dodge=False, ax=ax)
plt.xlabel("Musim")
plt.ylabel("PM2.5")
plt.grid(True)
st.pyplot(fig)
